...
/**
 * Low-level abstraction, which creates application window and starts the main
 * loop.
 * It's recommended to use {@link Application}, but this class could be extended
 * directly as well.
 * When extended, life-cycle methods should be called manually.
 */
public abstract class WindowWithImGui {
    ...
    /**
     * @return {@link Color} instance, which represents background color for the
     *         window
     */
